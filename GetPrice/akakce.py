...
def get_price_akakce(product_dict):
    """Takes the product dict and finds every price of individual item.
        ...
        :return
        product_dict_price['main_title]=[detail_dict, image, link, site_price, akakce_price]
    ...
    for product_main_name, values in product_dict.items():
        ...
        for product_category, product_name in product_details_dict.items():
            if product_category == 'i̇şlemci':
                ...
                if 'Intel Core i3 12100F' in product_name:
                ...
                link = f'https://www.akakce.com/arama/?q={product_name}&s=2'
